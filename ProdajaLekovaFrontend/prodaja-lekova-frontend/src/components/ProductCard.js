...
const ProductCard = () => {
  ...
  return (
    <Card sx={{ height: '100%', width: '150%', display: 'flex', flexDirection: 'column',  boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.2)' }}>
      <CardMedia
        component="img"
        sx={{
          pt: '5%',
      ...
      <CardActions sx={{ mt: 1 }}>
        ...
        <Button size="small" variant='contained'>Dodaj u korpu</Button>
      </CardActions>
    </Card>
  )
}
